...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .lock-icon { font-size: 4rem; margin-bottom: 20px; animation: bounce 2s infinite; }
        @keyframes bounce { 0%,100% { transform: translateY(0); } 50% { transform: translateY(-10px); } }
        .lock-content h3 { color: #6ee7b7; margin: 0 0 15px 0 !important; font-size: 1.5rem; font-weight: bold; }
        .lock-content p { color: #9aa7b2; margin: 0 0 25px 0 !important; font-size: 1rem; }
        .lock-content a { 
            background: #6ee7b7;
            color: #0f1724;
            padding: 12px 35px;
        ...
        .lock-content a:hover { background: #5dd4a4; }
    ...
    <main>
        ...
        <div class="cta-section">
            ...
            <div class="cta-buttons">
                ...
                <?php else: ?>
                    <a href="login.php" class="cta-btn cta-btn-primary">Iniciar Sesión</a>
                    <a href="login.php?register=1" class="cta-btn cta-btn-secondary">Crear Cuenta</a>
                <?php endif; ?>
            </div>
        </div>
    </main>
